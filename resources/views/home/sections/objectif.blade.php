<style>
    .bg-commander-one {
        background-image: url('{{ asset('img/fond_movil_1.png') }}');
    }
    @media (min-width: 1024px) {
        .bg-commander-one {
            background-image: url('{{ asset('img/FOND_CLAIR_1.png') }}');
        }
    }
</style>

<section class="w-full min-h-screen bg-cover bg-center sm:bg-top bg-no-repeat px-6 py-12 text-white bg-commander-one {{ $mission->status ? '' : 'hidden' }}">

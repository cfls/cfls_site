...
<div class="mt-10">
    <div class="w-full max-w-screen-2xl px-4 md:px-8 mx-auto flex items-center justify-center py-16"
        ...
        <div class="flex lg:grid lg:grid-cols-2 gap-8 xl:gap-16 items-center w-full mt-20">
            ...
            <div class="mt-10">
                <div class="ml-auto place-self-center lg:col-span-7 mt-10">
                    <h1 class="text-center uppercase font-extrabold tracking-tight text-gray-900 mb-8
    text-2xl sm:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl w-full ">
                        {{ $members->title }}
                    </h1>

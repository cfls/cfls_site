        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900">
                    Gestion des associations de vidéos
                </h1>
                <p class="mt-2 text-sm text-gray-600">
                    Gérer et modifier les questions de type Association
                </p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm font-semibold text-gray-900">Associations de vidéos</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Assocations</th>
